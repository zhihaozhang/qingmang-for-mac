...
class overviewController: NSViewController,NSTableViewDelegate,NSTableViewDataSource {
    ...
    func tableViewSelectionDidChange(_ notification: Notification) {
        ...
        if let detail = splitVC.childViewControllers[1] as? detailViewController{
            ...
            webContent = "<head><style>p{font-family: \"Helvetica Neue\",Helvetica,Arial,Sans-serif;} img{max-width:400px !important; height:auto;} body,html{overflow-x:hidden;} p{font-size:20px;  line-height: 1.5; text-indent : 20px;}</style></head><h2 style=\"text-align:center;font-family: STKaiti;\">"+self.feed!["articles"][row]["title"].string!+"</h2><hr style=\"height:8px;border:none;border-top:4px solid #EDEDED;\" /><body> \(webContent)</body>"
